    ...
    return widget.buildContainer(
      ...
      FormBuilderTextField(
        ...
        validator: (val) {
          ...
          return switch (T) {
            String => widget.validator?.call(trimmedVal as T?),
            int => widget.validator?.call(
                trimmedVal == null ? null : int.tryParse(trimmedVal) as T?),
            double => widget.validator?.call(
                trimmedVal == null ? null : double.tryParse(trimmedVal) as T?),
            Type() => widget.validator?.call(trimmedVal as T?),
          };
        },
        ...
        valueTransformer: (value) {
          ...
          return switch (T) {
            String => trimmedValue as T?,
            int =>
              trimmedValue == null ? null : int.tryParse(trimmedValue) as T?,
            double =>
              trimmedValue == null ? null : double.tryParse(trimmedValue) as T?,
            _ => trimmedValue as T?
          };
        },
